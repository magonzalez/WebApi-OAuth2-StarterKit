...
namespace StarterKit.WebApi.Results
{
    ...
    /// content negotiation on an <see cref="HttpError"/> based on a <see cref="ValidationException"/>.
    /// </summary>
    public class ValidationExceptionResult : IHttpActionResult
    {
        ...
        /// <param name="exception">The validation exception information to include in the error.</param>
        ...
        public ValidationExceptionResult(ValidationException exception, bool includeErrorDetail, IContentNegotiator contentNegotiator, HttpRequestMessage request, IEnumerable<MediaTypeFormatter> formatters)
        ...
        public ValidationExceptionResult(ValidationException exception, ApiController controller)
            : this(exception, new ApiControllerDependencyProvider(controller))
        {
        }

        private ValidationExceptionResult(ValidationException exception, IDependencyProvider dependencies)
        {
            if (exception == null)
            {
